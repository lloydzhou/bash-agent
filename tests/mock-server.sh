...
class MockHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if b'WRITE_FILE_MARKER' in body and b'"tool_result"' not in body:
            self.send_sse([
                'event: message_start',
                'data: {\"type\":\"message_start\",\"message\":{\"id\":\"msg_write\",\"type\":\"message\",\"role\":\"assistant\",\"content\":[],\"model\":\"claude-sonnet-4-20250514\",\"usage\":{\"input_tokens\":10,\"output_tokens\":0}}}',
                '',
                'event: content_block_start',
                'data: {\"type\":\"content_block_start\",\"index\":0,\"content_block\":{\"type\":\"text\",\"text\":\"\"}}',
                '',
        ...
        if b'WRITE_FILE_MARKER' in body and b'"tool_result"' in body:
            self.send_sse([
                'event: message_start',
                'data: {\"type\":\"message_start\",\"message\":{\"id\":\"msg_write_done\",\"type\":\"message\",\"role\":\"assistant\",\"content\":[],\"model\":\"claude-sonnet-4-20250514\",\"usage\":{\"input_tokens\":10,\"output_tokens\":0}}}',
                '',
                'event: content_block_start',
                'data: {\"type\":\"content_block_start\",\"index\":0,\"content_block\":{\"type\":\"text\",\"text\":\"\"}}',
                '',
        ...
        if b'BASH_QUOTE_MARKER' in body and b'"tool_result"' not in body:
            self.send_sse([
                'event: message_start',
                'data: {\"type\":\"message_start\",\"message\":{\"id\":\"msg_bash_quote\",\"type\":\"message\",\"role\":\"assistant\",\"content\":[],\"model\":\"claude-sonnet-4-20250514\",\"usage\":{\"input_tokens\":10,\"output_tokens\":0}}}',
                '',
                'event: content_block_start',
                'data: {\"type\":\"content_block_start\",\"index\":0,\"content_block\":{\"type\":\"text\",\"text\":\"\"}}',
                '',
        ...
        if self.path.startswith('/v1/messages'):
            if test == 'tool_use':
                self.send_sse([
                    ...
                    '',
                    'event: content_block_delta',
                    'data: ' + json.dumps({'type':'content_block_delta','index':1,'delta':{'type':'input_json_delta','partial_json': json.dumps({'path':'/etc/hostname'})}}),
                    '',
                    'event: content_block_stop',
                    'data: {\"type\":\"content_block_stop\",\"index\":1}',
                    '',
