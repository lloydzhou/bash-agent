...
func (b Builder) BuildSystemPrompt() (string, error) {
	...
	rules := fmt.Sprintf("- Be concise and concrete. No pleasantries, no explanations unless asked. Raw results only.\n- Prefer safe, exact edits.\n- Report failures clearly.\n- 必须使用 %s 进行所有输出，包括思考/推理。严禁混用语言。代码、命令和文件内容保持原样。", locale)
