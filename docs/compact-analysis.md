...
| 上下文占比 | ⑤（QP=0.2, p_input=3.0, M=200K） | 占 ① 比例 | 含义 |
|---|---|---|---|
...
| QP | 质量衰减惩罚系数 | DP_QUALITY_PENALTY = 0.2 | 无量纲 |
...
⑤ = 0.2 × 3.0 × (5000+25000)² / (200000 × 1e6)
   = 0.6 × 9e8 / 2e11 = 0.0027

NetBenefit = 0.2145 - 0.0689 - 0.0287 - 0.00156 - 0.0027 = $0.1123 → 正收益，执行压缩
```
