...
tool_param_keys() {
    case "$1" in
        ...
        Bash) printf 'command timeout background' ;;
...
tool_sub_agent() {
    ...
    (( SUB_AGENT_DEPTH < 1 )) || { echo "sub-agent recursion limit reached; child agents cannot launch SubAgent"; return 1; }
    ...
    (
        ...
        export SUB_AGENT_DEPTH=$(( SUB_AGENT_DEPTH + 1 ))
